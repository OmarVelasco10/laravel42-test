...
export const Cotization = () => {
  ...
  return (
    <div className="w-full bg-dark lg:container">
      <div className="border-2 border-yellow-500 rounded-full flex items-center justify-between lg:flex-no-wrap lg:rounded-full lg:overflow-hidden lg:max-w-[80%] xl:max-w-[90%] lg:flex-col xl:flex-row lg:items-baseline">
        <div className="flex lg:w-2/3">
          <div className="bg-yellow-500 lg:w-[40%] lg:rounded-t-lg xl:rounded-t-none lg:rounded-l-full lg:rounded-bl-none lg:rounded-tr-none xl:rounded-l-none xl:rounded-r-none w-1/3 p-4 rounded-l-full flex justify-between">
            <p className="font-bold text-xl">{priceSend} €</p>
            <Link className="text-xl" to="/">
              Secci
            </Link>
          </div>
          <div className="lg:w-2/3 w-full flex mt-0 items-center justify-center p-2">
            <p className="text-lg">
        ...
        <div className="w-full lg:w-auto lg:ml-auto lg:text-right">
      ...
      <div className="flex flex-col gap-4">
        {cotizations.map(
          (item: any, index: any) =>
            index !== 0 && (
              <div className="border-2 border-black rounded-full flex items-center justify-between lg:max-w-[80%]">
